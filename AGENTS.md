...
| Tests | `tests/` (14 projects; see REFERENCE-STATUS.md for verified counts) |
...
# TASKFLOW_AI_PROVIDER=AzureInference|OpenAICompatible|None selects the lane-compatible LLM client; local default None - D-041/D-060
