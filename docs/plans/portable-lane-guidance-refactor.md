...
| P2 | Six switch skeletons with existing arms + fallbacks, Data Protection switch, lifted credential, pooler option, selector tests, architecture rules (A.1) | sonnet | running | feature/pl-p2-switches | scaffold-proof-wt/pl-p2 | a8d6f9235007166e8 |
